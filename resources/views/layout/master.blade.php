...
<body id="kt_app_body" data-kt-app-layout="light-sidebar" data-kt-app-sidebar-enabled="true"
    data-kt-app-header-fixed="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true"
                ...
                <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
                    ...
                    <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
                        <a href="{{ route('regular') }}" class="d-lg-none">
                            <img alt="Logo" src="{{ asset('/') }}media/logos/favicon.png" class="h-30px" />
                        </a>
                    </div>
                    <!--end::Mobile logo-->
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-lg-grow-1"
                        ...
                        <h1 class="mb-0 text-welcome"><span style="font-weight: normal; color: #8D8D8D;">Hello,</span>
                            Irfan Hafizh
                        </h1>
                        <!--begin::Navbar-->
                        <div class="app-navbar flex-shrink-0">
                            <!--begin::Col-->
                            <div class="col-md-6 fv-row select-version-wrapper">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px"
                                    ...
                                    <div class="menu-item px-3">
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                ...
                                                <a href="#"
                                                    class="fw-semibold text-muted text-hover-primary fs-7">irfanhafizh53@gmail.com</a>
                                            </div>
                                            <!--end::Username-->
                                        </div>
                                    </div>
                                    ...
                                    <div class="menu-item px-5">
                                        <a href="{{ route('account.issues') }}" class="menu-link px-5">
                                            <span class="menu-icon">
                                                <span class="svg-icon svg-icon-2">
                                                    <i class="iconify" data-icon="mdi-message-text-outline"></i>
                                                </span>
                                            </span>
                                    ...
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-5">
                                        <a href="{{ route('sign_in') }}" class="menu-link px-5">
                                            <span class="menu-icon">
                                                <span class="svg-icon svg-icon-2">
                    ...
                    <div class="d-flex flex-column flex-column-fluid">
                        ...
                        <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                            ...
                            <div id="kt_app_toolbar_container"
                                class="hr-fix app-container container-fluid d-flex flex-stack">
                                <!--begin::Page title-->
                                    ...
                                    <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                        ...
                                        <li class="breadcrumb-item text-muted">
                                            ...
                                            <a href="{{ route('regular') }}"
                                                class="text-muted text-hover-primary">PocketYou
                                                Asia</a>
                                            @elseif (request()->is('vip*'))
                                ...
                                <div class="d-flex align-items-center gap-2 gap-lg-3">
                                    <!--begin::Col-->
                                    <div class="col-md-6 fv-row" style="width: fit-content;">
                                        @if (request()->is('regular') || request()->is('vip') ||
                                        request()->is('retail'))
                                        <select id="selectVersion" class="form-select" name="selectVersion">
                        ...
                        <div
                            ...
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="https://keenthemes.com" target="_blank"
                                    class="text-gray-800 text-hover-primary">PocketYou.</a>
                            </div>
                            <!--end::Copyright-->
                        </div>
