...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">Retail Merchant Registration</span>
        </h3>
    </div>
    <!--end::Header-->
    <!--begin::Body-->
    ...
    <form action="#">
        <div class="card-body py-3">
            ...
            <div class="mb-10">
                <label for="deposit_amount" class="required form-label">Deposit Amount</label>
                <input type="text" id="deposit_amount" class="form-control" placeholder="Deposit Amount" />
            </div>
