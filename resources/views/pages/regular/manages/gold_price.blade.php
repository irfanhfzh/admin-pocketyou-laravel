...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">Gold Price List</span>
        </h3>
        <!--begin::Filter menu-->
                ...
                <tbody>
                    <tr>
                        <td class="text-center">
                            <a href="javascript:goldDetail(0)">4</a>
                        </td>
                        <td class="text-center">Indonesia</td>
                        <td class="text-end">Rp 1.049.070</td>
                        <td class="text-end">Rp 5.245.350</td>
                    </tr>
                    <tr>
                        <td class="text-center">
                            <a href="javascript:goldDetail(1)">16</a>
                        </td>
                        <td class="text-center">Malaysia</td>
                        <td class="text-end">RM 308.55</td>
                        <td class="text-end">RM 1,542.75</td>
                    </tr>
                </tbody>
            </table>
            <!--end::Table-->
