            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="text-center"><a href="javascript:detailProduct(0)">Edit</a></td>
                    </tr>
                    <tr>
                        <td class="text-center"><a
                        ...
                        <td class="text-center"><label class="badge badge-info">Preparing</label></td>
                        <td class="text-center"><a href="javascript:detailProduct(1)">Edit</a></td>
                    </tr>
                    <tr>
                        <td class="text-center"><a
                        ...
                        <td class="text-center"><label class="badge badge-info">Preparing</label></td>
                        <td class="text-center"><a href="javascript:detailProduct(2)">Edit</a></td>
                    </tr>
                    <tr>
                        <td class="text-center"><a
                        ...
                        <td class="text-center"><label class="badge badge-info">Preparing</label></td>
                        <td class="text-center"><a href="javascript:detailProduct(3)">Edit</a></td>
                    </tr>
                    <tr>
                        <td class="text-center"><a
                        ...
                        <td class="text-center"><label class="badge badge-info">Preparing</label></td>
                        <td class="text-center"><a href="javascript:detailProduct(4)">Edit</a></td>
                    </tr>
                </tbody>
            </table>
            <!--end::Table-->
