...
<div class="card mb-5 mb-xl-8">
    ...
    <div class="card-header border-0 pt-5">
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold fs-3 mb-1">Pre Purchase (Reward)</span>
        </h3>
        <!--begin::Filter menu-->
                ...
                <tbody>
                    <tr>
                        <td class="text-center">
                            1 </td>
                        <td>Bonus First Reload Pre Purchase</td>
                        <td>12 Aug 2023 10:51</td>
                        <td>Rp 2.500</td>
                    </tr>
                    <tr>
                        <td class="text-center">
                            2 </td>
                        <td>Bonus Pre Purchase 0.03%</td>
                        <td>12 Aug 2023 10:51</td>
                        <td>Rp 139</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="text-center">
                            5 </td>
                        <td>Reward MasterPiece Royalty</td>
                        <td>09 Aug 2023 11:00</td>
                        <td>Rp 781.660</td>
                    </tr>
                </tbody>
            </table>
