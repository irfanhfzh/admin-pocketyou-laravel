...
use App\Http\Controllers\Account\AccountIssuesController;
...
Route::prefix('account')->group(function() {
    Route::get('/profile', [AccountProfileController::class, 'profile'])->name('account.profile');
    Route::get('/issues', [AccountIssuesController::class, 'issues'])->name('account.issues');
});
